...
extern DungeonInfoTable dungeonTable[DUNGEON_TABLE_LENGTH];
...
extern const DWORD		Pet_Table[31][2];
const int 				SPECIAL_BORN_PETS_MAX_NUM = 1;
extern const DWORD 		Special_Born_Attr_Table[SPECIAL_BORN_PETS_MAX_NUM][4][2];
extern const DWORD 		Pet_Type_Attr_Table[9][3][2];
extern const DWORD		Pet_Skill_Table[23][23];
extern const DWORD		Pet_SKill_TablePerc[5][21];
#endif
...
// new stuff
extern const uint8_t arrSkills[JOB_MAX_NUM][SKILL_GROUP_MAX_NUM][6];
