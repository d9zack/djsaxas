...
struct emotion_type_s
{
	...
	{ "??",		"backflip",			0,											1.0f,	60	},
	{ "??",		"boxing",			0,											1.0f,	61	},
	{ "??",		"breakdance",		0,											1.0f,	62	},
	{ "??",		"dab",				0,											1.0f,	63	},
	{ "??",		"facepalm",			0,											1.0f,	64	},
	{ "??",		"jerkoff",			0,											1.0f,	65	},
	{ "??",		"new_dance_1",		0,											1.0f,	66	},
	{ "??",		"pushkick",			0,											1.0f,	67	},
	{ "??",		"throw_money",		0,											1.0f,	68	},
	{ "??",		"new_dance_2",		0,											1.0f,	69	},
	{ "??",		"twerk",			0,											1.0f,	70	},
		
	{ "??",		"sex",				NEED_PC | OTHER_SEX_ONLY | BOTH_DISARM,		1.0f,	71	},
	{ "??",		"licking",			NEED_PC | OTHER_SEX_ONLY | BOTH_DISARM,		1.0f,	72	},
	{ "??",		"blowjob",			NEED_PC | OTHER_SEX_ONLY | BOTH_DISARM,		1.0f,	73	},
#endif
	{ "\n",	"\n",		0,						0.0f },		
	/*
...
#ifdef __NEW_EMOTION_SYSTEM__
	if (emotion_types[i].iIndex >= 60)
	{
		if (!ch->IsVIP())
		{
			ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("Only VIP member can use special emotions."));
			return;
		}
	}
#endif
