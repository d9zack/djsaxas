...
// QUICKSLOT HANDLING
/////////////////////////////////////////////////////////////////////////////
void CHARACTER::SyncQuickslot(BYTE bType, UINT bOldPos, UINT bNewPos) // bNewPos == 255 ¸é DELETE
{
	if (bOldPos == bNewPos)
		return;
...
bool CHARACTER::SetQuickslot(UINT pos, TQuickslot & rSlot)
{
    ...
    switch (rSlot.type)
    {
        case QUICKSLOT_TYPE_ITEM:
            ...
            if (false == srcCell.IsDefaultInventoryPosition() && false == srcCell.IsBeltInventoryPosition() && false == srcCell.IsSpecialInventoryPosition())
                return false;
