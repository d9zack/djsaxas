...
ItemCountType	g_bItemCountLimit = 200;
...
std::string	g_stAdminPagePassword = "Bjs923jsdi2k8u7su";
...
int g_server_id = 0;
string g_strWebMallURL = "192.168.56.1";
	...
	*log_db = '\0';
	...
	while (fgets(buf, 256, fp))
	{
		...
		TOKEN("mfb_server")
		{
			...
			fprintf(stdout, "-----------------------------------\n");
			fprintf(stdout, "MFB_SERVER: I am the master\n");
			fprintf(stdout, "-----------------------------------\n");
			continue;
		}
